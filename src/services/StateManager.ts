 ...
 */
 export enum PortSceneState {
    ...
    Event = 1,
    Trial = 2,
    BungalowCrewManifest = 3,
    BungalowGatherIntel = 4,
    BungalowOfficerSummaries = 5,
    BungalowOptions = 6,
    BungalowShipManifest = 7,
    ColonialOfficeBribe = 8,
    ColonialOfficeOptions = 9,
    ColonialOfficeRoyalPardon = 10,
    ColonialOfficeWritOfProtection = 11,
    ShipyardBuy = 12,
    ShipyardOptions = 13,
    ShipyardOutfit = 14,
    ShipyardRepair = 15,
    ShipyardSell = 16,
    TavernBuySupplies = 17,
    TavernFireCrew = 18,
    TavernHireCrew = 19,
    TavernFireOfficers = 20,
